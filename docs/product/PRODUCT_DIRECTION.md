...
- Current maturity: alpha; source package metadata is `0.10.0b0` for production PyPI beta preparation. Latest GitHub prerelease: `v0.9.9-alpha`; `v0.9.8-alpha` remains the first public alpha baseline. Historical TestPyPI proof remains `qa-z==0.9.8a0`.
