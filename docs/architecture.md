...
- Repair prompts and adapters: `src/qa_z/repair_handoff.py`, `src/qa_z/adapters/`, and repair command modules render Codex, Claude Code, Cursor, aider, OpenHands, and generic handoff material without calling live model APIs.
...
Agent support remains adapter-oriented. QA-Z writes handoff material for external tools; the core planner and runners stay model-agnostic.
