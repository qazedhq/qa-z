...
- Evidence: GitHub workflow docs tests passed `23`; launch-growth and public current-truth tests passed `34`; text hygiene, Ruff check, Ruff format check, diff whitespace, and QA-Z help all passed. Generated `.pytest_cache` and `.ruff_cache` were removed.
